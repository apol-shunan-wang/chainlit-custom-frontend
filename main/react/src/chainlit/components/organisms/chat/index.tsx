import { useUpload } from "chainlit/hooks";
...
import ScrollContainer from "chainlit/components/molecules/messages/ScrollContainer";
...
const Chat = () => {
  ...
  const onFileUploadError = useCallback((error: string) => toast.error(error), [
    toast
  ]);
