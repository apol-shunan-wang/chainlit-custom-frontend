...
import { prepareContent } from "chainlit/utils/message";

import Divider from "@mui/material/Divider";
import Stack from "@mui/material/Stack";
import Typography from "@mui/material/Typography";

import { Collapse } from "chainlit/components/atoms/Collapse";
import { InlinedElements } from "chainlit/components/atoms/elements/InlinedElements";
import { CURSOR_PLACEHOLDER } from "chainlit/components/molecules/BlinkingCursor";
import { Markdown } from "chainlit/components/molecules/Markdown";
...
${output}`}
    ...
    if (message.input && message.showInput) {
      ...
      const {
        ...
        language:
          typeof message.showInput === "string" ? message.showInput : undefined
      });
